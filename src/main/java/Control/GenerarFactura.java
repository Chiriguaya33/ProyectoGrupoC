...
//ESTRUCTURA DE LA FACTURA
    ...
    String line = "--------------------------------------FACTURA--------------------------------------\n";
     String imageFile = "C:/Users/usuario/Desktop/Proyecto_SisControl_Pernos_y_TuercaGrupoF_Venta"
...
document.add(img);//SE AGREGA LA IMAGEN AL DOCUMENTO
 LocalDateTime ahora = LocalDateTime.now();
    ...
    document.add(new Paragraph(line+"FERRETERIA\n"
    +"Fecha de emision: "+fechaHoraActual+"\n"+"Numero de Factura: "+dt.getIdfactura()+"\nCEDULA:"+dt.getCedula()+
